...
function cbnb_add_bottom_nav() {
    ...
    <nav class="bottom-nav">
        <a href="https://geargeek.in/" class="nav-item <?php echo is_home() ? 'active' : ''; ?>">
        ...
        <a href="https://whatsapp.com/channel/0029VaiZR2kBadmdHWmPlW1v" class="nav-item whatsapp-item" target="_blank" rel="nofollow noopener noreferrer">
        ...
        <a href="https://geargeek.in/blog" class="nav-item">
